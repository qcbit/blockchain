...
// CORE NOTE: On startup or when reorganizing the blockchain, the node needs to be in
// sync with the rest of the network. This includes the mempool and blockchain database.
