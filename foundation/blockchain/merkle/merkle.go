...
// https://github.com/cbergoon/merketree
// Licensed under the MIT License, see LICENSE file.
// This code has been cleaned up, refactored, and turned into generics.

// Package merkle provides an implementation of a merkle tree
// for validation support for the blockchain.
package merkle
...
// if anyone tries to marshal the Merkle tree. Note: Use the Values function to
// return a slice that can be marshaled.
func (t *Tree[T]) MarshalText() (text []byte, err error) {
	panic("do not marshal the merkle tree, use Values() instead")
}
